...
{{< accordion >}}
  {{< accordion-item title="Atik 8 arete sou òganizasyon konkou nan Leta" show="true" >}}
...
{{< alert color="info" >}}
  **Le mérite dans la fonction publique**
  ...
  {{</* link cue="true"  href="https://doi.org/10.1787/84581cb5-fr" >}}Pour plus de détail{{< /link */>}}
{{< /alert >}}

*L'administration haïtienne tirerait profit d'un {{< link cue="true"  href="https://doi.org/10.1787/9789264280724-en" >}}recrutement fondé sur les competénces{{< /link >}}. Ces compétences peuvent être acquises par les administrations de differentes manières, comme indiqué dans le graphique.*
...
{{< nav tab-type="tabs" id="tabs-1" >}}
  ...
  {{< /nav-item >}}
  {{< nav-item title="Gérer les aptitudes dans la fonction publique" show="true" >}}
